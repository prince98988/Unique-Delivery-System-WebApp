...
class UpdateItem extends Component{
    ...
    handleSubmit(values) {
       ...
       values={...values,_id:this.state.item._id}
       this.props.putItem(values,this.state.imageFile,flag);
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-12">
                    <h3>Update Your Shop Item: { this.state.item.name }</h3>
                    <hr />
                </div>
            </div>
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={4}>
                                <Control.text  model=".unit" id="unit" name="unit"
                                   ...
                                   defaultValue={this.state.item.unit}
                                   className="form-control"
                                   validators={{
                        ...
                        <Row className="form-group">
                            ...
                            <Col md={3}>
                                <Control.select model=".parts" name="parts"
                                    defaultValue={this.state.item.parts}
                                    className="form-control"  
                                   >
